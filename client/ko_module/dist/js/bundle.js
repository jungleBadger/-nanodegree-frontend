...
},{"babel-runtime/core-js/json/stringify":4,"babel-runtime/core-js/promise":5}],2:[function(require,module,exports){
"use strict";
...
(function (window) {
	...
	var http = require("../../etc/js/http");

	http.get("/matrix?origins=4800 El camino Real, Los Altos, CA&destinations=2465 Lathem Street, Mountain View, CA").then(function (response) {
...
},{"../../etc/js/http":1,"./model/GmapModel":3,"knockout":76}],3:[function(require,module,exports){
"use strict";
...
},{"core-js/library/fn/json/stringify":6}],5:[function(require,module,exports){
