...
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("#app[data-v-1fffbe12] {\n\twidth: 100%;\n\theight:100%;\n\tmargin: 0;\n\tpadding: 0;\n\tbox-sizing: border-box;\n\tdisplay: flex;\n\toverflow: hidden;\n}\n\n#app > *[data-v-1fffbe12] {\n\tbox-sizing: inherit;\n}\n\n#wrapper[data-v-1fffbe12] {\n\tflex: 1;\n\tflex-direction: column;\n\tdisplay: flex;\n\twidth: 100%;\n\theight: 100%;\n}\n\n#map[data-v-1fffbe12] {\n\twidth: 100%;\n\tflex: 1;\n\tmin-height: 50%;\n}")
;(function(){
"use strict";
...
(function () {
	...
	var MapModel = require("../model/GmapModel");
	...
	module.exports = {
		...
		"beforeMount": function beforeMount() {
			...
			window.setTimeout(function () {
				_this.map = new window.google.maps.Map(document.getElementById("map"), new MapModel(-22.85833, -47.22));
			}, 0);
		},
		"components": {},
		...
		"methods": {
				...
				return new _promise2.default(function (resolve, reject) {
					_this2.geoCoder.geocode({
						...
						if (results && results.length && results[1]) {
							...
							reject({ results: results, status: status });
						}
					});
				});
			},
			"setContent": function setContent(lat, lng, address, id) {
				var _this3 = this;

				var wrapper = document.createElement("div");
				var removeBtn = document.createElement("button");
				var latInfo = document.createElement("span");
				var lngInfo = document.createElement("span");
				...
				removeBtn.addEventListener("click", function () {
					_this3.markers[_this3.markers.findIndex(function (marker) {
						return marker.id === id;
					})].setMap(null);
				});
			...
			"addMarker": function addMarker() {
				...
				marker.addListener("click", function () {
					...
					_this4.getAddress(position.lat, position.lng).then(function (address) {
						_this4.infoWindow.setContent(_this4.setContent(position.lat, position.lng, address, position.id));
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('main',{attrs:{"id":"app"}},[_c('div',{attrs:{"id":"wrapper"}},[_c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.lat),expression:"lat"}],attrs:{"type":"number"},domProps:{"value":(_vm.lat)},on:{"input":function($event){if($event.target.composing){ return; }_vm.lat=$event.target.value}}}),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.lng),expression:"lng"}],attrs:{"type":"number"},domProps:{"value":(_vm.lng)},on:{"input":function($event){if($event.target.composing){ return; }_vm.lng=$event.target.value}}}),_vm._v(" "),_c('button',{on:{"click":_vm.addMarker}},[_vm._v("Add Marker")])]),_vm._v(" "),_c('div',{attrs:{"id":"map"}})])])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-1fffbe12"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1fffbe12", __vue__options__)
  } else {
    hotAPI.reload("data-v-1fffbe12", __vue__options__)
  }
})()}

},{"../model/GmapModel":3,"../model/Position":4,"babel-runtime/core-js/promise":5,"vue":76,"vue-hot-reload-api":75,"vueify/lib/insert-css":77}],2:[function(require,module,exports){
"use strict";
...
},{"./components/app.vue":1,"vue":76}],3:[function(require,module,exports){
"use strict";
...
},{"core-js/library/fn/promise":6}],6:[function(require,module,exports){
...
},{"../modules/_core":14,"../modules/es6.object.to-string":69,"../modules/es6.promise":70,"../modules/es6.string.iterator":71,"../modules/es7.promise.finally":72,"../modules/es7.promise.try":73,"../modules/web.dom.iterable":74}],7:[function(require,module,exports){
...
},{"./_core":14,"./_export":20,"./_global":23,"./_promise-resolve":48,"./_species-constructor":56}],73:[function(require,module,exports){
'use strict';
...
},{"./_export":20,"./_new-promise-capability":40,"./_perform":47}],74:[function(require,module,exports){
